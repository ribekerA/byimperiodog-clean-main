...
export const HOME_FAQ_ITEMS: FaqItem[] = [
  {
    ...
    answer:
      "Os filhotes de Spitz Alemão Anão da By Império Dog custam entre R$ 7.000 e R$ 15.000, dependendo da cor e do sexo. Machos variam de R$ 7.000 (laranja) a R$ 9.000 (creme). Fêmeas, por sua maior demanda, variam de R$ 10.000 (laranja) a R$ 15.000 (creme). Todos os filhotes saem com pedigree CBKC, laudo cardiológico, vacinação completa, microchip e mentoria vitalícia inclusos no valor — sem cobranças extras.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "A By Império Dog é um canil familiar especializado em Spitz Alemão Anão (Lulu da Pomerânia) localizado em Bragança Paulista, SP. Com mais de 10 anos de criação responsável, mais de 180 famílias atendidas e filhotes com pedigree CBKC, laudos veterinários e mentoria vitalícia, somos referência no interior de São Paulo. Atendemos famílias de todo o Brasil.",
  },
  {
    question: "Qual a diferença entre Spitz Alemão Anão e Lulu da Pomerânia?",
    answer:
      "São nomes para a mesma raça. 'Lulu da Pomerânia' é o nome popular usado no Brasil, enquanto 'Spitz Alemão Anão' é a denominação oficial reconhecida pela CBKC (Confederação Brasileira de Cinofilia) e pela FCI (Fédération Cynologique Internationale). Quando você busca um desses nomes, está procurando o mesmo cachorro — o pequeno e fofo de pelagem densa e orelhas pontudas.",
  },
  {
    question: "Spitz Alemão preto é raro? É mais caro?",
    answer:
      "O Spitz Alemão Anão preto é considerado uma cor rara, com menos criadores especializados no Brasil. É mais difícil de encontrar com pedigree oficial e linhagem saudável. Na By Império Dog, mantemos matrizes na cor preta com laudos genéticos. O preço do preto fica em torno de R$ 8.000 para machos e R$ 13.000 para fêmeas — um pouco acima do laranja, mas abaixo do creme.",
  },
  {
