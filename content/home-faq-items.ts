...
export const HOME_FAQ_ITEMS: FaqItem[] = [
  {
    ...
    answer:
      "Os filhotes de Spitz Alemão Anão (Lulu da Pomerânia) da By Império Dog custam entre R$ 7.000 e R$ 15.000, dependendo da cor e do sexo. Machos variam de R$ 7.000 (laranja) a R$ 9.000 (creme). Fêmeas, por sua maior demanda, variam de R$ 10.000 (laranja) a R$ 15.000 (creme). Todos os filhotes saem com pedigree CBKC, laudo cardiológico, vacinação completa, microchip e mentoria vitalícia inclusos no valor — sem cobranças extras.",
  },
  {
