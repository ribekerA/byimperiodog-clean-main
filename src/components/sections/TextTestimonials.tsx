...
// palavra.
//
// Os dez últimos vieram depois, entregues pelo canil como texto solto: sem
// nome, sem cidade, sem foto e sem nota. Entram assim mesmo. Cartão sem
// identidade é honesto; cartão com identidade inventada é depoimento falso — e
// era isso que o site tinha antes da auditoria. Por isso `name`, `city`,
// `puppy`, `photo` e `stars` são opcionais: quando a criadora confirmar quem
// escreveu, é só preencher o campo e o cartão passa a se apresentar sozinho.
type Depoimento = {
