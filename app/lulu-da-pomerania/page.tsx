...
const FAQS = [
  {
    ...
    answer:
      "Sim, são nomes para exatamente o mesmo cão. 'Lulu da Pomerânia' é o apelido popular no Brasil; 'Spitz Alemão Anão' é a denominação oficial reconhecida pela CBKC e FCI. Em inglês, a raça é chamada 'Pomeranian'. Qualquer uma dessas buscas refere-se ao mesmo animal fofo, compacto e de pelagem densa.",
  },
  {
    question: "Quanto custa um Lulu da Pomerânia?",
    answer:
      "Na By Império Dog, os preços variam de R$ 7.000 a R$ 15.000 dependendo da cor e do sexo. Machos a partir de R$ 7.000 (laranja) e fêmeas a partir de R$ 10.000. O valor inclui pedigree CBKC, laudos veterinários, vacinação completa, microchip e mentoria vitalícia — sem cobranças extras.",
  },
  {
  ...
  return (
    <main className="mx-auto max-w-4xl space-y-14 px-5 py-14 text-zinc-800 sm:px-8">
      ...
      <section aria-labelledby="precos-heading" className="rounded-3xl border border-emerald-100 bg-emerald-50/40 p-6 sm:p-8 space-y-4">
        ...
        <p className="text-xs text-zinc-400">Inclui pedigree CBKC, laudos, vacinação, microchip e mentoria vitalícia. <Link href="/preco-spitz-anao" className="underline hover:text-emerald-700">Ver tabela completa →</Link></p>
      </section>
