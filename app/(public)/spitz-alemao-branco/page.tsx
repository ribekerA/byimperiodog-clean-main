...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "A tabela atual parte de R$ 8.500 para macho e R$ 9.500 para fêmea — o maior valor entre as cinco cores divulgadas, nos dois sexos.",
  },
  {
...
export default function SpitzAlemaoBrancoPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-14 px-5 py-14 text-zinc-800 sm:px-8">
      ...
      <section aria-labelledby="avaliar-heading" className="space-y-4">
        ...
        <ul className="grid gap-3 sm:grid-cols-2">
          {[
            ...
            "Consulta veterinária, hemograma completo e protocolo vacinal correspondentes ao filhote",
          ].map((item) => (
      ...
      <section aria-labelledby="faq-branco-heading">
          ...
          {FAQS.map((item, index) => (
            <div key={item.question}>
              <details className="group py-4" open={index === 0}>
                <summary className="flex cursor-pointer list-none items-start justify-between gap-4 rounded-sm text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500">
