...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "A tabela atual traz R$ 7.500 para macho e R$ 8.500 para fêmea. Os valores da cor branca ainda são de referência: confirme com a equipe o preço do filhote disponível antes de reservar.",
  },
  {
    ...
    <div className="mx-auto max-w-4xl space-y-14 px-5 py-14 text-zinc-800 sm:px-8">
      ...
      <section aria-labelledby="preco-branco-heading" className="rounded-3xl border border-amber-200 bg-amber-50 p-6 sm:p-8">
        ...
        <p className="mt-3 text-sm leading-relaxed text-zinc-700">
          A tabela atual traz R$ 7.500 para macho e R$ 8.500 para fêmea. Na cor branca esses valores são de referência: confirme com a equipe o preço e a disponibilidade do filhote antes de reservar.
        </p>
